...
if (
    ...
    $bookingId = $order->get_meta(
        '_nyp_cal_booking_id'
    );

?>

<div class="nyp-express-box">
    ...
    <?php if ( empty( $bookingId ) ) : ?>
        ...
        $scheduleUrl = wp_nonce_url(

            home_url(
                '/schedule-express-consultation/?order='
                . $order->get_id()
            ),

            'nyp_express_booking_'
            . $order->get_id()
        ...
        <div class="nyp-express-status pending">
        ...
        <a
            ...
            href="<?php echo esc_url( $scheduleUrl ); ?>"
        >
    ...
    <?php else : ?>
        ...
        <div class="nyp-express-status success">
        ...
        <?php if ( $bookingDate = $order->get_meta( '_nyp_cal_booking_date' ) ) : ?>
